...
<body>
    ...
    <section id="Apropos">
        ...
        <div class="description">
            ...
            <p>Bonjour , Je suis un étudiant agé de 23 ans en 1ere Année de BTS SIO (Services Informatiques aux Organisations) à Caen Sup</p>
            <p>Pour plus d'informations, vous pouvez me contacter via la section contact qui se trouve en bas de la page. Vous pouvez également télécharger mon CV si vous le souhaitez.</p>
    ...
    <section id="Contact">
        ...
        <div class="screen">
            <div class="carte">
                <img src="Images/IMG_7.jfif " alt="Profil">
                <h2>Richard GOMIS</h2>
